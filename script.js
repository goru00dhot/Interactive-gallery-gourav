...
const images = [
  { src: 'images/img1.jpg', caption: 'Standing side ot road', details: 'This image captures a backside of mine to looking at roads.' },
  { src: 'images/img2.jpg', caption: 'Sunkissing', details: 'A sunshine reflexes on the face, and my face is glowing.' },
  ...
  { src: 'images/img10.jpg', caption: 'Coffee cups', details: 'Two steaming cups of coffee, ready for a cozy conversation.' },
  { src: 'images/img11.jpg', caption: 'Tea cup', details: 'A delicate tea cup with a soothing warm beverage.' },
  { src: 'images/img12.jpg', caption: 'Black tea and milk', details: 'A beautiful contrast between black tea and creamy milk being poured in.' }
];
